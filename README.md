...
| File | Description |
|------|-------------|
| `music_database_mysql.sql` | Full database schema + data (MySQL) |
| `Music_Store_Query_MySQL.sql` | All analysis queries (MySQL) |
...
1. Import `music_database_mysql.sql` into your MySQL server
2. Open and run queries from `Music_Store_Query_MySQL.sql`
